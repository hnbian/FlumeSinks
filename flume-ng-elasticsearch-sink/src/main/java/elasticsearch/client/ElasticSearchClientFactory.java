...
public class ElasticSearchClientFactory {
  ...
  public ElasticSearchClient getClient(String clientType, String[] hostNames,
    ...
    }/* else if (clientType.equalsIgnoreCase(JsonTransportClient) && serializer != null) { //Json es sink client

        return new ElasticSearchJsonTransportClient(hostNames, clusterName, serializer);
