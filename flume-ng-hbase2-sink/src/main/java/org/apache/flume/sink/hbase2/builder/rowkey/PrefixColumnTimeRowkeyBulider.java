...
public class PrefixColumnTimeRowkeyBulider extends Bulider implements RowkeyBulider {
    ...
    public PrefixColumnTimeRowkeyBulider(RowkeyFixBulider rowkeyFixBulider,String columns,String columnTime,String rowkeySplit){
    ...
    public byte[] bulider(JSONObject jsonObject) throws UnsupportedEncodingException, CloumnNotFoundException {
        ...
        return Bytes.add(rowkeyFixBulider.bulider(columnTimeValue),split,columnRowkeyBulider.bulider(jsonObject));
    }
